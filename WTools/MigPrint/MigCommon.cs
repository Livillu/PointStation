...
{
    public struct RoleDescriptionType
    {
        public BAN Identifier;     //`xml:"Identifier"`
        public string Name; //`xml:"Name"`
        public string Address;// `xml:"Address,omitempty"`
    }
    //銷貨資料查詢參數
    ...
    internal class MigCommon
    {
        public static string Psconnection = "server=192.168.1.252;user id=sa;password=dsc@53290529;database=WP01;port=1433";

        public static string Nletter = "0123456789";//數字判斷

        public static string Aletter = "QWERTYUIOPLKJHGFDSAZXCVBNM";

        public static string MigVer = "4.1";

        public static string SellerId = "53290529";

        public static string SellerName = "璿智國際寵物科技有限公司";

        public static string SellerAddr = "嘉義市東區後湖里保義路327號";

        public static string V3j0002 = "QWERTYUIOPLKJHGFDSAZXCVBNM1234567890.-+";
        
        string Errormsg;
        byte[] Msg;
      
        //公司資料預設值
        public static RoleDescriptionType MyBan()
        {
            RoleDescriptionType MyBanVal;
            MyBanVal.Identifier = SellerId;
            MyBanVal.Name = SellerName;
            MyBanVal.Address = SellerAddr;
            return MyBanVal;
        }
        //自己公司RoleDescription
        public static RoleDescriptionType Myselfe(string banid)
        {
        ...
        //路人甲
        public static RoleDescriptionType NoOneBan()
        {
            RoleDescriptionType NoBanVal;
            NoBanVal.Identifier = "0000000000";
            NoBanVal.Name = "0000000000";
            NoBanVal.Address = "";
            return NoBanVal;
        }
        //供應商RoleDescription
        ...
        public static string RoleDescriptionType_Checked(RoleDescriptionType c)
        {
            string errmsg = "";
            if (c.Identifier == "") errmsg += "識別碼欄位錯誤!!!\t";
            if (c.Name == "" || c.Name.Length > 60) errmsg += "名稱欄位錯誤!!!\t";
            if (c.Address != "" && c.Address.Length > 100) errmsg += "地址欄位錯誤!!!\t";
            return errmsg;
        }
        //千位數註記，
        ...
        public string InvoiceTrack(string invoiceTrack)
        {
            ...
            if (invoiceTrack.Length == 2 && Aletter.Contains(no1) && Aletter.Contains(no2)) errmsg = "";
            return errmsg;
        }
        ...
        public static string SequenceChecked(string c)
        {
        ...
        //客戶RoleDescription
        public static RoleDescriptionType Buyer(string banid)
        {
        ...
        票
        */
        public static string InvoiceTypeEnum_Checked(InvoiceTypeEnum c)
        {

            string errmsg = "發票類別[" + c + "]格式錯誤!!!!\t";
            if ("07,08".Contains(c)) errmsg = "";
            return errmsg;
        }
        ...
        */
        ...
        public string AllowanceTypeEnum_Checked(AllowanceTypeEnum n)
        {
            ...
            if (n.Length == 1 && "12".Contains(n)) errmsg = "";
            return errmsg;
        }
        ...
        public static string BAN_Checked(BAN n)
        {
            string errmsg = "統一編號[" + n + "]格式錯誤!!!!\t";
            UInt32 s;
            bool isok = UInt32.TryParse(n, out s);
        ...
        public string BuyerRemarkEnum_Checked(BuyerRemarkEnum n)
        {
            ...
            if (n == "") errmsg = "";
            else if (n.Length == 1 && "1234".Contains(n)) errmsg = "";
            return errmsg;
        }
        ...
        為必填欄位)
        */
        public static string CustomsClearanceMarkEnum_Checked(CustomsClearanceMarkEnum n)
        {
            string errmsg = "通關方式[" + n + "]格式錯誤!!!!\t";
            if (n == "") errmsg = "";
            else if (n.Length == 1 && "12".Contains(n)) errmsg = "";
            return errmsg;
        }
        ...
        QQ12345678
        */
        public static string InvoiceNumberType_Checked(InvoiceNumberType n)
        {
            string errmsg = "發票編號[" + n + "]格式錯誤!!!!\t";
            string tmp = n.Substring(2, 8);
            
            if (n !=null && n.Length == 10 && Aletter.Contains(n.Substring(0, 1).ToUpper()) && Aletter.Contains(n.Substring(1, 1).ToUpper()))
            {
                UInt32 s = 0;

                bool isok = UInt32.TryParse(n.Substring(2, 8), out s);
                if (isok) errmsg = "";
            }
            return errmsg;
        }
        ...
        */
        public static string DonateMarkEnum_Checked(DonateMarkEnum n)
        {
            string errmsg = "捐贈註記[" + n + "]格式錯誤!!!!\t";
            if (n.Length == 1 && "01".Contains(n)) errmsg = "";
            return errmsg;
        }
        ...
        息 C0401 使用)
        */
        public static string TaxTypeEnum_Checked(TaxTypeEnum n)
        {
            string errmsg = "稅率註記[" + n + "]格式錯誤!!!!\t";
            if (n.Length == 1 && "12349".Contains(n)) errmsg = "";
            return errmsg;
        }
        ...
        */
        ...
        public string c3J0002(string CarrierId)
        {
            ...
            else
            {
                for (int v = 1; v < 8; v++)
                {
                    if (!V3j0002.Contains(CarrierId.Substring(v, v + 1)))
                    {
        ...
        public string cCQ0001(string CarrierId)
        {
            ...
            else
            {
                for (int i = 0; i < 16; i++)
                {
                    ...
                    if (i < 2)
                    {
                        if (!Aletter.Contains(v))
                        {
                            errmsg = "CarrierId:編碼錯誤!!!\t";
                            break;
                        }
                    }
                    else if (!Nletter.Contains(v))
                    {
                        errmsg = "CarrierId:編碼錯誤!!!\t";
                        break;
                    }
        ...
        */
        ...
        /台灣時區僅支援西元年方式
        例:20170101*/
        public static string DateType_Checked(DateType n)
        {
        ...
        public static string TimeType_Checked(TimeType n)
        {
        ...
        */
        ...
        public static string TaxRateEnum_Checked(TaxRateEnum n)
        {
        ...
        public string ZeroTaxRateReasonEnum_Checked(ZeroTaxRateReasonEnum n)
        {
            ...
            if (n == "") errmsg = "";
            else if (n.Length == 2 && "71,72,73,74,75,76,77,78,79".Contains(n)) errmsg = "";
            return errmsg;
        }
        ...
        public static string CurrentInvoce(string invoice, string date)
        {
